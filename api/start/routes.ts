...
router.post('/v1/weather-stations/:slug/sensors/:sensor_slug', [SensorsController, 'write']).use(middleware.userAuthentication({
  min_role: "recorder"
}))

router.get('/v1/weather-stations/:slug/sensors/:sensor_slug/now', [SensorsController, 'read']).use(middleware.userAuthentication())
